...
final class Store: ObservableObject {
    ...
    private let fileName = "studyfund_entries.json"
    ...
    static func seedData() -> [Entry] {
        let now = Date()
        return [
            Entry(title: "Sample Goal One", detail: "First example entry.", date: now),
            Entry(title: "Sample Goal Two", detail: "Second example entry.", date: now.addingTimeInterval(-86400)),
            Entry(title: "Sample Goal Three", detail: "Third example entry.", date: now.addingTimeInterval(-172800)),
        ]
    }
}
